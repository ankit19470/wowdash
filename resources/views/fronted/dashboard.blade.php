...
<aside class="sidebar">
    ...
    <div>
      <a href={{url('list-user')}} class="sidebar-logo">
        <img src="{{url('fronted/logo/dw-icon.png')}}" alt="site logo" class="light-logo">
        <img src="{{url('fronted/logo/dw-icon.png')}}" alt="site logo" class="dark-logo">
