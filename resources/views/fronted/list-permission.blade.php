            ...
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        ...
                        <li>
                            <a href="{{ url('add-role') }}"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>
                                add role</a>
                        </li>
                            ...
                            @foreach ($permissions as $permission)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href={{ '/update-permission/' . $permission->id }}
                                            class="text-primary bi bi-pencil"></a>

                                        <a class="text-danger bi bi-trash deleteUser" data-id="{{ $permission->id }}"
